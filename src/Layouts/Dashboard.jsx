...
//           } bg-gray-300 w-64 dark:bg-gray-800`}
//         tabIndex="-1"
...
//                 className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
//               >
//                 <FaSignOutAlt className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"></FaSignOutAlt>
...
const Dashboard = () => {
  ...
  const menus = [
    ...
    { name: "Sign Out", link: "/", icon: RiSettings4Line},
  ];
  ...
  return (
    <div>
      ...
      <div
        className={`text-white bg-gradient-to-r from-gray-700 via-gray-900 to-black min-h-screen ${
          open ? "w-72" : "w-16"
